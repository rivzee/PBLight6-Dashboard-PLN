...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.D:\Kerja\PBLight_DashboardPLN\public\storage' => 'string',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.D:\\Kerja\\PBLight_DashboardPLN\\public\\storage','logging.default','logging.deprecations.channel',
...
'login.process','logout','dashboard','dashboard.master','dashboard.admin',
'dashboard.user','dashboard.admin.keuangan','dashboard.admin.risiko','dashboard.admin.skreperusahaan','dashboard.admin.perencanaan_operasi',
'dashboard.admin.pengembangan_bisnis','dashboard.admin.human_capital','dashboard.admin.k3l','dashboard.admin.perencanaan_korporat','dashboard.admin.sekretaris_perusahaan',
'dashboard.admin.hukum','kpi.index','kpi.history','kpi.laporan','kpi.show',
'eksporPdf.index','eksporPdf.bidang','eksporPdf.pilar','eksporPdf.keseluruhan','notifikasi.index',
'notifikasi.tandaiDibaca','notifikasi.tandaiSemuaDibaca','notifikasi.destroy','notifikasi.hapusSudahDibaca','notifikasi.getJumlahBelumDibaca',
'notifikasi.getNotifikasiTerbaru','aktivitasLog.index','aktivitasLog.eksporCsv','aktivitasLog.show','akun.index',
'akun.create','akun.store','akun.show','akun.edit','akun.update',
'akun.destroy','kpi.verifikasi','kpi.proses-verifikasi','verifikasi.index','verifikasi.show',
'verifikasi.update','verifikasi.destroy','verifikasi.massal','tahunPenilaian.index','tahunPenilaian.create',
'tahunPenilaian.store','tahunPenilaian.show','tahunPenilaian.edit','tahunPenilaian.update','tahunPenilaian.destroy',
'tahunPenilaian.activate','aktivitasLog.hapusLogLama','dataKinerja.index','dataKinerja.create','dataKinerja.store',
'dataKinerja.show','dataKinerja.edit','dataKinerja.update','realisasi.index','realisasi.create',
'realisasi.store','realisasi.show','realisasi.edit','realisasi.update','kpi.create',
'kpi.store','storage.local',);
        registerArgumentsSet('views', 
'aktivitasLog.index','aktivitasLog.show','akun.create','akun.edit','akun.index',
'akun.show','auth.login','dashboard','dashboard.admin','dashboard.admin_hukum',
'dashboard.admin_human_capital','dashboard.admin_k3l','dashboard.admin_keuangan','dashboard.admin_pengembangan_bisnis','dashboard.admin_perencanaan_korporat',
'dashboard.admin_perencanaan_operasi','dashboard.admin_risiko','dashboard.admin_sekretaris','dashboard.master','dashboard.user',
'kpi.history','kpi.index','kpi.laporan','kpi.show','kpi.user_index',
'layouts.app','layouts.guest','layouts.navigation','notifikasi.index','welcome',
